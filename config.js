...
const CONFIG = {
  ...
  SELECTION_SHAPE_H_SCALE: 1.6, // multiplier for chevron height vs base size
  ...
  SELECTION_GLOW_MID_ALPHA: 0.9,
  SELECTION_GLOW_INNER_ALPHA: 0.9,
  SELECTION_OUTLINE_WIDTH_FACTOR: 0.5, // width = max(2, factor * size)
  SELECTION_OUTLINE_ALPHA: 0.6,
};
