...
const sampleStatus = {
  ...
  occupiedChannels: 0,
  assignedChannels: 1,
  orphanRecoveryActive: false,
  orphanRecoveryCandidates: 0,
...
const protocolSchemas = {
  ...
  gc_status: {
    ...
    optional: [
      "discoverySpreadingFactor",
      "discoveryBandwidthHz",
      "discoveryCodingRate",
      "discoverySilenceAirtimeMs",
      "discoveryJoinRequestAirtimeMs",
      "discoveryJoinAssignAirtimeMs",
      "discoveryJoinAckAirtimeMs",
      "noisyChannels",
      "freeChannels",
      "occupiedChannels",
      "assignedChannels",
      "orphanRecoveryActive",
      "orphanRecoveryCandidates",
  ...
  channel_table: {
    ...
    optional: [
      ...
      "channelSpacingMhz",
      "updatedAtGcMillis",
      "defaultRadioProfileId",
      "supportedRadioProfiles",
      "radioProfiles",
      "channels",
      "clearChannels",
      "noisyChannels",
