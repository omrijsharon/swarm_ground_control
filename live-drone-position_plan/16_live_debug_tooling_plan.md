...
- [x] MaGC now prefers the drone-requested profile/period when the request is valid for the selected profile. Legacy drones still use the configured default assignment profile.
