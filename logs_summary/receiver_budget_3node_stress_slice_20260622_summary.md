...
- Loss cycles: `9`
- Log: `logs_summary\receiver_budget_3node_stress_slice_20260622.jsonl`
...
| 6 | `accepted` | 7904.5 | yes | yes | join_request_received, post_bind_first_telemetry, assign_sent, telemetry_period_locked, join_ack_received, assignment_completed | pass |
| 7 | `accepted` | - | no | no | join_request_received, assign_sent, join_ack_received, assignment_completed | fail |
...
- Recovery budget used: `521`
- Recovery budget denied: `526`
- Healthy service protected: `526`
