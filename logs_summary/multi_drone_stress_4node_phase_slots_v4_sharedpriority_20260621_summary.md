...
- Loss cycles: `9`
- Log: `logs_summary\multi_drone_stress_4node_phase_slots_v4_sharedpriority_20260621.jsonl`
...
| 3 | `accepted` | 45216.7 | no | yes | join_request_received, post_bind_first_telemetry, assign_sent, join_ack_received, assignment_completed, telemetry_period_locked | pass |
| 6 | `accepted` | 221.5 | yes | yes | post_bind_first_telemetry, telemetry_period_locked | pass |
| 7 | `accepted` | 9377.5 | yes | yes | join_request_received, post_bind_first_telemetry, assign_sent, telemetry_period_locked, join_ack_received, assignment_completed | pass |
