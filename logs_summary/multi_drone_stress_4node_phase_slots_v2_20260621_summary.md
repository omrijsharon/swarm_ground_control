...
- Loss cycles: `9`
- Log: `logs_summary\multi_drone_stress_4node_phase_slots_v2_20260621.jsonl`
...
|---:|---|---:|---|---|---|---|
| 2 | `missing` | - | no | no | join_request_received, assign_sent | fail |
| 3 | `accepted` | 25925.6 | yes | yes | join_request_received, assign_sent, join_ack_received, assignment_completed, post_bind_first_telemetry, telemetry_period_locked | pass |
| 6 | `accepted` | 12254.4 | yes | yes | join_request_received, assign_sent, join_ack_received, assignment_completed, post_bind_first_telemetry, telemetry_period_locked | pass |
| 7 | `accepted` | 18184.0 | yes | yes | join_request_received, assign_sent, join_ack_received, assignment_completed, post_bind_first_telemetry, telemetry_period_locked | pass |
...
- Missing ACKs: `multi-stress-startup-drone2-0012`
- Rejected commands: `0`
- MaGC ACK timeouts: `0`
