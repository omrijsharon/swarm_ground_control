...
- Loss cycles: `9`
- Log: `logs_summary\20260622_receiver_budget_shortloss_priority1.jsonl`
...
|---:|---|---:|---|---|---|---|
| 3 | `accepted` | 27226.0 | yes | yes | join_request_received, post_bind_first_telemetry, assign_sent, telemetry_period_locked, join_ack_received, assignment_completed | pass |
| 6 | `accepted` | 6813.8 | yes | yes | join_request_received, post_bind_first_telemetry, assign_sent, join_ack_received, telemetry_period_locked, assignment_completed | pass |
| 7 | `accepted` | 13729.6 | yes | yes | join_request_received, post_bind_first_telemetry, assign_sent, join_ack_received, assignment_completed | pass |
