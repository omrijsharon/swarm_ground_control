...
- Loss cycles: `9`
- Log: `logs_summary\20260622_receiver_budget_fastjoin10_3node.jsonl`
...
|---:|---|---:|---|---|---|---|
| 3 | `accepted` | 18918.6 | yes | yes | join_request_received, post_bind_first_telemetry, telemetry_period_locked, assign_sent, join_ack_received, assignment_completed | pass |
| 6 | `accepted` | 13382.3 | yes | yes | join_request_received, post_bind_first_telemetry, assign_sent, join_ack_received, telemetry_period_locked, assignment_completed | pass |
| 7 | `accepted` | 7455.4 | yes | yes | join_request_received, post_bind_first_telemetry, assign_sent, telemetry_period_locked, join_ack_received, assignment_completed | pass |
...
- Recovery budget denied: `95`
- Healthy service protected: `95`
