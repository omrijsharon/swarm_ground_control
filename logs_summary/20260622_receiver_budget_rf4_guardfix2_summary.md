...
- Loss cycles: `9`
- Log: `logs_summary\20260622_receiver_budget_rf4_guardfix2.jsonl`
...
|---:|---|---:|---|---|---|---|
| 3 | `accepted` | - | no | no | join_request_received, assign_sent | fail |
| 6 | `accepted` | 114867.8 | no | no | join_request_received, post_bind_first_telemetry, telemetry_period_locked, assign_sent | pass |
| 7 | `accepted` | 70696.7 | no | no | join_request_received, post_bind_first_telemetry, telemetry_period_locked, assign_sent, join_ack_received, assignment_completed | pass |
